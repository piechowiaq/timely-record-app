...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-white dark:text-gray-700 leading-tight">Edit Workspace</h2>
    </template>

    <div class="px-2 pb-2">
      <div class="space-y-2 scroll-region">
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow">
          <UpdateWorkspaceInformationForm :workspace="workspace" class="max-w-xl"/>
        </div>
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow">
          <div class="max-w-xl flex justify-between">
            <header>
            ...
            <Link :href="route('workspaces.edit-registries', [projectId, workspace])">
              <SecondaryButton class="hover:border-amber-600 border-amber-600">
                Sync Registries
              </SecondaryButton>
            </Link>
