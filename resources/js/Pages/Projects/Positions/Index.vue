...
const props = defineProps(["filters", "positions", "projects"]);
...
watch(
    index.value,
    debounce(() => {
        router.get(route("positions.index"), index.value, {
            preserveState: true,
            replace: true,
        });
    }, 300),
                        ...
                        >
                            <tr>
                                ...
                                <th
                                    class="px-6 py-2"
                                    scope="col"
                                    @click="sort('department_id')"
                                >
                                    Department
                                    <i
                                        :class="
                                            getSortIconClass('department_id')
                                        "
                                    ></i>
                                </th>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Link
                                        v-else-if="position.project_id === null"
                                        :href="
