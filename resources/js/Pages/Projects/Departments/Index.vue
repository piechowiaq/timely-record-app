...
const props = defineProps(["filters", "departments", "projects"]);
...
watch(
    index.value,
    debounce(() => {
        router.get(route("departments.index"), index.value, {
            preserveState: true,
            replace: true,
        });
    }, 300),
                            ...
                            <tr
                                ...
                                :class="{
                                    ...
                                    'border-b dark:border-gray-700':
                                        index !== departments.data.length - 1,
                                }"
                            >
                                <th
                                ...
                                >
                                    <ApplicationLogo
                                        v-if="department.project_id === null"
