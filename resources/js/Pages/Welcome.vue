    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
      <div class="px-10">
        ...
        <div class="mt-6 text-gray-500 text-justify">
          ...
          dokumentacji w obiektach hotelowych, aby zapewnić, że wszystkie ważne dokumenty i rekordy są aktualizowane i
          nie przeterminowane. Aplikacja koncentruje się na automatyzacji przepływu pracy i upewnieniu się, że wszelka
          dokumentacja, tak jak umowy, certyfikaty czy inne ważne dokumenty są aktualizowane zgodnie z wymaganiami
          prawnymi oraz standardami branży hotelowej.
        </div>
      </div>
            ...
            <div>
              ...
              <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                ...
                <a
                    ...
                    class="underline hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-gray-500"
                >Forge</a
                >,
                <a
