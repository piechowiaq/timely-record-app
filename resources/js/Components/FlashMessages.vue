...
<template>
  <div class="block whitespace-nowrap">
    <div v-if="$page.props.flash.success && show"
         class="sm:mt-0 mt-2 flex items-center justify-between p-1 bg-green-500 rounded">
      <div class="flex items-center">
        <svg class="flex-shrink-0 ml-4 mr-2 w-2 h-2 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show"
         class="sm:mt-0 mt-2 flex items-center justify-between p-1 bg-red-500 rounded">
      <div class="flex items-center">
        <svg class="flex-shrink-0 ml-4 mr-2 w-2 h-2 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          <path
