...
<template>
    <div class="block whitespace-nowrap">
        <div
            ...
            class="mt-2 flex items-center justify-between rounded bg-green-500 p-1 sm:mt-0"
        >
            <div class="flex items-center">
                <svg
                    class="ml-4 mr-2 h-2 w-2 flex-shrink-0 fill-white"
            ...
            <button type="button" class="group ml-6 mr-2" @click="show = false">
                <svg
        ...
        <div
            v-if="
                ...
                show
            "
            class="mt-2 flex items-center justify-between rounded bg-red-500 p-1 sm:mt-0"
        >
            <div class="flex items-center">
                <svg
                    class="ml-4 mr-2 h-2 w-2 flex-shrink-0 fill-white"
                ...
                <div v-else class="text-xs font-medium text-white">
